...
/* { dg-final { scan-assembler-times "\tvmerge\.vim" 88 {target { rv32 }} } } */
/* { dg-final { scan-assembler-times "\tvmerge\.vxm" 44 {target { rv32 }} } } */
...
/* { dg-final { scan-assembler-times "\tvmerge\.vim" 88 {target { rv64 }} } } */
